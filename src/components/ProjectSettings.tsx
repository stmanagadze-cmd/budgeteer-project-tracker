        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="hourlySalary"
              type="number"
              value={project.hourlySalary}
              onChange={(e) => onUpdateProject({ hourlySalary: parseFloat(e.target.value) || 0 })}
              placeholder="0.00"
              min="0"
              step="0.01"
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => onUpdateProject({ targetBudget: parseFloat(e.target.value) || 0 })}
              placeholder="0.00"
              min="0"
              step="0.01"
            />
